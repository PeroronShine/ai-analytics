...
if uploaded_file is not None and api_key:
    try:
        ...
        prompt_text = f"""Ты - профессиональный аналитик данных. 
ЗАПРОС ПОЛЬЗОВАТЕЛЯ:
{user_request}
...
2. Если запрос общий — проведи полный анализ: описание датасета, найди: паттерны, статистику, рекомендации. 
**КЛЮЧЕВЫЕ МЕТРИКИ**
   - Средние, медианы, min, max для числовых колонок
   - Распределения и основные статистики

**ЗАКОНОМЕРНОСТИ И ТРЕНДЫ**
   - Паттерны, корреляции, динамика
